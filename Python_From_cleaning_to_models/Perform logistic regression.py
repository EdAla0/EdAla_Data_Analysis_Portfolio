...
satisfaction_number = df_original['satisfaction'].value_counts(dropna = False)

print(satisfaction_number, satisfaction_number[0]/(satisfaction_number[0]+satisfaction_number[1]))
